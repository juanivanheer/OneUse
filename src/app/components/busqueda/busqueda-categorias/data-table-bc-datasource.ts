 ...
 */
export class DataTableBusquedaCategoria extends DataSource<BusquedaCategoria> {

    data: BusquedaCategoria[];
    ...
    constructor(private paginator: MatPaginator, private sort: MatSort, private busqueda: BusquedaCategoria[]) {
        super();
     ...
     */
    connect(): Observable<BusquedaCategoria[]> {
     ...
     */
    private getPagedData(data: BusquedaCategoria[]) {
