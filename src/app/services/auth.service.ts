...
export class AuthService {
  ...
  private _registerUrl = "https://oneuse-backend.herokuapp.com/api/register"
  private _loginUrl = "https://oneuse-backend.herokuapp.com/api/login"
  private _confirmar = "https://oneuse-backend.herokuapp.com/api/confirmation"
  private _userData = "https://oneuse-backend.herokuapp.com/api/user-data?email="
  private _updateUser = "https://oneuse-backend.herokuapp.com/api/update-user?id="
  private _getImgUser = "https://oneuse-backend.herokuapp.com/api/get-img-name/"
  private _registerPublicacion = "https://oneuse-backend.herokuapp.com/api/register-publicacion?email="
  private _getPublicacion = "https://oneuse-backend.herokuapp.com/api/get-publicacion/"
  private _getPublicacionId = "https://oneuse-backend.herokuapp.com/api/get-one-publicacion/"
  private _getPublicacionesDestacadas = "https://oneuse-backend.herokuapp.com/api/get-publicaciones-destacadas/"
  private _deletePublicacion = "https://oneuse-backend.herokuapp.com/api/delete-publicacion/"
  private _updatePublicacion = "https://oneuse-backend.herokuapp.com/api/update-publicacion/"
  private _searchCategoria = "https://oneuse-backend.herokuapp.com/api/search-categoria/"
  private _searchPalabra = "https://oneuse-backend.herokuapp.com/api/search-palabra"
  private _preguntaPublicacion = "https://oneuse-backend.herokuapp.com/api/pregunta/"
  private _respuestaPublicacion = "https://oneuse-backend.herokuapp.com/api/respuesta/"
  private _pyrPublicacion = "https://oneuse-backend.herokuapp.com/api/pyr/"
  private _pyrOnePublicacion = "https://oneuse-backend.herokuapp.com/api/onePyR/"
  private _nuevaNotificacionPregunta = "https://oneuse-backend.herokuapp.com/api/notificacion-pregunta/"
  private _nuevaNotificacionRespuesta = "https://oneuse-backend.herokuapp.com/api/notificacion-respuesta/"
  private _notificacionesNuevas = "https://oneuse-backend.herokuapp.com/api/nuevas-notificaciones/"
  private _notificacionesTodas = "https://oneuse-backend.herokuapp.com/api/todas-notificaciones/"
  private _notificacionVista = "https://oneuse-backend.herokuapp.com/api/notificacion-vista/"
  private _notificacionCaducidadEntregaPropietario = "https://oneuse-backend.herokuapp.com/api/notificacion-caducidad-entrega-propietario/"
  private _notificacionCaducidadEntregaLocatario = "https://oneuse-backend.herokuapp.com/api/notificacion-caducidad-entrega-locatario/"
  private _mailPassword = "https://oneuse-backend.herokuapp.com/api/lostpassword/"
  private _newpwd = "https://oneuse-backend.herokuapp.com/api/newpwd/"
  private _alquilerProcesoPago = "https://oneuse-backend.herokuapp.com/api/registrar-alquiler/"
  private _getAlquilerPropietario = "https://oneuse-backend.herokuapp.com/api/get-alquiler-publicaciones/"
  private _getAlquilerPropios = "https://oneuse-backend.herokuapp.com/api/get-alquiler-propios/"
  private _registrarEnProcesoEntrega = "https://oneuse-backend.herokuapp.com/api/registrar-proceso-entrega/"
  private _getPropietarioAlquiler = "https://oneuse-backend.herokuapp.com/api/get-propietario-alquiler/"
  private _registrarCodigoPropietarioEntrega = "https://oneuse-backend.herokuapp.com/api/registrar-entrega-locatario/"
  private _registrarCodigoLocatarioEntrega = "https://oneuse-backend.herokuapp.com/api/registrar-entrega-propietario/"
  private _registrarReclamo = "https://oneuse-backend.herokuapp.com/api/cancelar-alquiler/"
  private _registrarVisitaPublicacion = "https://oneuse-backend.herokuapp.com/api/visitas-publicaciones/"
  private _registrarEnProcesoDevolucion = "https://oneuse-backend.herokuapp.com/api/registrar-demora-devolucion/"
  private _getVisitas = "https://oneuse-backend.herokuapp.com/api/get-visitas-publicacion/"
  private _registrarCodigoDevolucionPropietario = "https://oneuse-backend.herokuapp.com/api/registrar-finalizacion-propietario/"
  private _registrarCodigoDevolucionLocatario = "https://oneuse-backend.herokuapp.com/api/registrar-finalizacion-locatario/"
  private _getAllUsers = "https://oneuse-backend.herokuapp.com/api/get-all-users/"
  private _deleteUser = "https://oneuse-backend.herokuapp.com/api/delete-user/"
  private _updateSuperadminUser = "https://oneuse-backend.herokuapp.com/api/update-superadmin-user"
  private _getAllPublicaciones = "https://oneuse-backend.herokuapp.com/api/get-all-publicaciones"
  private _updateSuperadminPublicacion = "https://oneuse-backend.herokuapp.com/api/update-superadmin-publicacion"
  private _getAllAlquileres = "https://oneuse-backend.herokuapp.com/api/get-all-alquileres"
  private _deleteAlquiler = "https://oneuse-backend.herokuapp.com/api/delete-alquiler/"
  private _getAlquilerId = "https://oneuse-backend.herokuapp.com/api/get-alquiler-id/"
  private _updateSuperadminAlquiler = "https://oneuse-backend.herokuapp.com/api/update-superadmin-alquiler/"
  private _getEstadisticaPublicacionesCategorias = "https://oneuse-backend.herokuapp.com/api/get-publicaciones-x-categoria"
  private _cancelarAlquiler = "https://oneuse-backend.herokuapp.com/api/cancelarAlquiler"
  private _getTiposDniMercadoPago = "https://api.mercadopago.com/v1/identification_types"
  private _postPagoTarjeta = "https://oneuse-backend.herokuapp.com/api/pago-tarjeta-mp"
